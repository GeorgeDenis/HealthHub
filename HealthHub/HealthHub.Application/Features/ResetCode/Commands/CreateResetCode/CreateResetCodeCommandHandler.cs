...
namespace HealthHub.Application.Features.ResetCode.Commands.CreateResetCode
{
    ...
    {
        private readonly IPasswordResetCodeRepository resetCodeRepository;
        private readonly IEmailService emailService;
        private readonly IUserManager userManager;
        public CreateResetCodeCommandHandler(IPasswordResetCodeRepository resetCodeRepository, IUserManager userManager, IEmailService emailService)
        {
